...
class ScreeningsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create screening" do
    assert_difference('Screening.count') do
      post screenings_url, params: { screening: { reserved_seats: @screening.reserved_seats, rows: @screening.rows, show_id: @screening.show_id, total_seats: @screening.total_seats } }
    end
  ...
  test "should update screening" do
    patch screening_url(@screening), params: { screening: { reserved_seats: @screening.reserved_seats, rows: @screening.rows, show_id: @screening.show_id, total_seats: @screening.total_seats } }
