...
class ShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create show" do
    assert_difference('Show.count') do
      post shows_url, params: { show: { movie_id: @show.movie_id, show_time: @show.show_time } }
    end
  ...
  test "should update show" do
    patch show_url(@show), params: { show: { movie_id: @show.movie_id, show_time: @show.show_time } }
